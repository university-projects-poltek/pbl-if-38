    ...
    public function updateReportStatus(Request $request, $id, $status)
{
    ...
    $request->validate([
        'status' => 'required|in:Diproses,Selesai', // Pastikan status yang diterima hanya "Diproses" atau "Selesai"
    ]);
    ...
    return redirect()->route('officer.reportsTable')->with('success', 'Status laporan berhasil diubah.');
}
}